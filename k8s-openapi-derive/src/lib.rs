...
//! This crate contains proc macros related to the [`k8s-openapi`](https://crates.io/crates/k8s-openapi) crate.
//!
//! The macros in this crate are pre-compiled to wasm and executed using the [`watt`](https://crates.io/crates/watt) runtime.
//! To view the Rust source of the macros from which the wasm module is built,
//! go to <https://github.com/Arnavion/k8s-openapi/tree/master/k8s-openapi-derive-impl>

static MACRO_IMPL_BYTES: &[u8] = include_bytes!("k8s_openapi_derive_impl.wasm");
static MACRO: watt::WasmMacro = watt::WasmMacro::new(MACRO_IMPL_BYTES);
...
pub fn derive_custom_resource_definition(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
	MACRO.proc_macro_derive("derive_custom_resource_definition", input)
}
