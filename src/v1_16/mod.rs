...
// Generated from operation getDiscoveryV1alpha1APIResources

/// get available resources
///
/// Use the returned [`crate::ResponseBody`]`<`[`GetDiscoveryV1alpha1APIResourcesResponse`]`>` constructor, or [`GetDiscoveryV1alpha1APIResourcesResponse`] directly, to parse the HTTP response.
#[cfg(feature = "api")]
pub fn get_discovery_v1alpha1_api_resources(
) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> crate::ResponseBody<GetDiscoveryV1alpha1APIResourcesResponse>), crate::RequestError> {
    let __url = "/apis/discovery.k8s.io/v1alpha1/";
    let __request = crate::__build_request(
        crate::http::Method::GET,
        std::borrow::Cow::Borrowed(__url),
        &[],
...
/// Use `<GetDiscoveryV1alpha1APIResourcesResponse as Response>::try_from_parts` to parse the HTTP response body of [`get_discovery_v1alpha1_api_resources`]
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum GetDiscoveryV1alpha1APIResourcesResponse {
    Ok(crate::apimachinery::pkg::apis::meta::v1::APIResourceList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}

#[cfg(feature = "api")]
impl crate::Response for GetDiscoveryV1alpha1APIResourcesResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
                ...
                Ok((GetDiscoveryV1alpha1APIResourcesResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((GetDiscoveryV1alpha1APIResourcesResponse::Other(result), read))
            },
        }
    }
}
