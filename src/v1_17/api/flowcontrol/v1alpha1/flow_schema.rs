...
impl FlowSchema {
    ...
    pub fn create_flow_schema(
        ...
        let __url = "/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas?";
...
impl FlowSchema {
    ...
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> crate::ResponseBody<ReadFlowSchemaResponse>), crate::RequestError> {
...
impl FlowSchema {
    ...
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> crate::ResponseBody<ReadFlowSchemaStatusResponse>), crate::RequestError> {
